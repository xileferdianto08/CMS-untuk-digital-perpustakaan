...
<?php foreach ($buku as $b) { ?>
    <div class="container text-center">
        ...
        <button class="btn btn-warning rounded-pill mt-3"><a href="<?= base_url('/buku/editBuku/') . $b['slug'] ?>" class="linkText">Edit data buku</a></button>
    ...
    <div class="container" style="margin-left: 35%; margin-top:5%">
        <p><strong>Kategori:</strong> <a href="<?= base_url('/buku/bukuPerKategori/') . $b['idKategori'] ?>" class="badge btn rounded-pill linkText2 text-bg-secondary "><?= $b['namaKategori'] ?></a></p>
