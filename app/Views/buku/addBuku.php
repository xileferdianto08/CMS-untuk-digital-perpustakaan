...
<div class="row">
    <div class="col-md-6 mx-auto mt-5">
        <div class="bg-white rounded-lg shadow-lg p-3 ">
            <h3 class="text-center">Tambah Buku Baru</h3>
            <?php $validationErr = \Config\Services::validation(); ?>
            <form action="<?= base_url('/buku/doAddBuku') ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="mb-2 pt-4">
                    <div class="col-lg-1"></div>
                    <label for="judul" class="form-label mt-2">Judul Buku</label>
                    <div class="col-lg-12">
                        <input type="text" class="form-control" name="judul" placeholder="Judul Buku Anda" required>
                    </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="col-lg-12">
                        <textarea name="deskripsi" cols="20" rows="10" class="form-control" placeholder="Deskripsi buku anda" required></textarea>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="col-lg-1"></div>
                ...
                <div class="mb-2">
                    ...
                    <div class="col-lg-12">
                        <input name="pdfBuku" type="file" class="form-control" required>
                    </div>
                    <div class="form-text">Maksimal ukuran file 2MB/2048KB.</div>
                ...
                <div class="mb-2">
                    ...
                    <div class="col-lg-12">
                        ...
                        <img id="fotoBaru" src="<?= base_url('/assets/img/default.png') ?>" alt="Cover Buku" width="50%" onclick="triggerClick()">
                    </div>
