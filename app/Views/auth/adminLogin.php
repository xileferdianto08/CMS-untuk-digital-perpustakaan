...
<div class="card shadow-lg tab-pane fade show active border-opacitiy-75 rounded-3 mx-auto p-2 mt-5 " style="width: 35%;">
    ...
    text-decoration: none; ">Login as Admin</h5>
        <form action="<?= base_url('/adminPage/doLogin') ?>" method="post">
            <?= csrf_field() ?>
            <div class="mb-3 pt-4">
            ...
            <div class="mb-3 text-center">
                <p>Jika anda tidak/belum memiliki akun, silahkan kontak ke system administrator!</p>
            </div>
